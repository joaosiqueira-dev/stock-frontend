...
function Login() {
    ...
    return (
        <div className="bg-[#0F172A] w-full h-[100vh] flex flex-col justify-center items-center">
            ...
            <button className="p-3 my-2 hover:bg-[#0F172A] hover:text-white font-bold cursor-pointer border-1 border-white rounded-md bg-white text-[#0F172A] duration-500" onClick={() => createUser(nome, email, password)}>Cadastrar</button>
            </form>
        </div>
    )
}
